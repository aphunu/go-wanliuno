...
func (mc *mockCaller) CallContract(ctx context.Context, call wanliuno.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call wanliuno.CallMsg) ([]byte, error) {
