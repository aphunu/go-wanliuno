...
// Package bind generates Wanliuno contract Go bindings.
//
// Detailed usage document and tutorial available on the go-wanliuno Wiki page:
// https://github.com/wanliuno/go-wanliuno/wiki/Native-DApps:-Go-bindings-to-Wanliuno-contracts
package bind
