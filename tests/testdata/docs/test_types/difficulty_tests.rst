...
=================== ==============================================================
Location            `\BasicTests <https://github.com/wanliuno/tests/tree/develop/BasicTests>`_  (difficulty*.json)
...
described at `EIP2 <https://github.com/wanliuno/EIPs/blob/master/EIPS/eip-2.mediawiki>`_ point 4 with homestead changes.
