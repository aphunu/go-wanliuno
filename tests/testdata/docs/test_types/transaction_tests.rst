...
Describes a complete transaction and its `RLP <https://github.com/wanliuno/wiki/wiki/RLP>`_ representation using the .json file.

=================== ==============================================================
Location            `/TransactionTests <https://github.com/wanliuno/tests/tree/develop/TransactionTests>`_
...
* ``blocknumber`` - indicates network rules for the transaction. Since blocknumber = **1000000** Homestead rules are applied to transaction. (see https://github.com/wanliuno/EIPs/blob/master/EIPS/eip-2.mediawiki)
