...
=================== ==============================================================
Location            `/VMTests <https://github.com/wanliuno/tests/tree/develop/VMTests>`_
...
(see https://github.com/wanliuno/py-evm/blob/7a96fa3a2b00af9bea189444d88a3cce6a6be05f/eth/tools/_utils/hashing.py#L8-L16)
