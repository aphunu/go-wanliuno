...
=================== ==============================================================
Location            `/GeneralStateTests <https://github.com/wanliuno/tests/tree/develop/GeneralStateTests>`_
...
.. note::
   ...
   `here <https://github.com/wanliuno/EIPs/issues/176>`_.
...
| ``currentNumber``
|	The current block's number. Also indicates network rules for the transaction. Since blocknumber = **1000000** Homestead rules are applied to transaction. (see https://github.com/wanliuno/EIPs/blob/master/EIPS/eip-2.mediawiki)
| ``currentTimestamp``
