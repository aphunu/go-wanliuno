...
import (
	...
	"github.com/wanliuno/go-wanliuno/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Wanliuno
...
func (eth *Wanliuno) startBloomHandlers(sectionSize uint64) {
...
// for the Wanliuno header bloom filters, permitting blazing fast filtering.
