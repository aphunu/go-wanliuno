...
// Syncing provides information when this nodes starts synchronising with the Wanliuno network and when it's finished.
...
type SyncingResult struct {
	...
	Status  wanliuno.SyncProgress `json:"status"`
}
