...
func (eth *Wanliuno) startEthEntryUpdate(ln *enode.LocalNode) {
...
func (eth *Wanliuno) currentEthEntry() *ethEntry {
	return &ethEntry{ForkID: forkid.NewID(eth.blockchain)}
}

// setupDiscovery creates the node discovery source for the eth protocol.
func (eth *Wanliuno) setupDiscovery(cfg *p2p.Config) (enode.Iterator, error) {
