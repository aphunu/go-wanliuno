...
import (
	...
	"github.com/wanliuno/go-wanliuno/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Wanliuno service within
	...
	if err != nil {
		t.Fatalf("failed to register Wanliuno protocol: %v", err)
	}
