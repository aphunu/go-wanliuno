...
import (
	...
	"github.com/wanliuno/go-wanliuno/ethclient"
)

// WanliunoClient provides access to the Wanliuno APIs.
type WanliunoClient struct {
	client *ethclient.Client
}

// NewWanliunoClient connects a client to the given URL.
func NewWanliunoClient(rawurl string) (client *WanliunoClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &WanliunoClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *WanliunoClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *WanliunoClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *WanliunoClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *WanliunoClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *WanliunoClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *WanliunoClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *WanliunoClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *WanliunoClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *WanliunoClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *WanliunoClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *WanliunoClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *WanliunoClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *WanliunoClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *WanliunoClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *WanliunoClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *WanliunoClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *WanliunoClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *WanliunoClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *WanliunoClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *WanliunoClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *WanliunoClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *WanliunoClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *WanliunoClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *WanliunoClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *WanliunoClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *WanliunoClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *WanliunoClient) SendTransaction(ctx *Context, tx *Transaction) error {
