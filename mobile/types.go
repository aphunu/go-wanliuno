...
// Header represents a block header in the Wanliuno blockchain.
type Header struct {
	header *types.Header
}
...
// Block represents an entire block in the Wanliuno blockchain.
type Block struct {
	block *types.Block
}
...
// Transaction represents a single Wanliuno transaction.
...
// Deprecated: use WanliunoClient.TransactionSender
