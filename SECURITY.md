...
Audit reports are published in the `docs` folder: https://github.com/wanliuno/go-wanliuno/tree/master/docs/audits 
...
To find out how to disclose a vulnerability in Wanliuno visit [https://bounty.wanliuno.org](https://bounty.wanliuno.org) or email bounty@wanliuno.org.
