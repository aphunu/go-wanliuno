...
func newYoloV1InstructionSet() JumpTable {
	...
	enable2315(&instructionSet) // Subroutines - https://eips.wanliuno.org/EIPS/eip-2315
...
func newIstanbulInstructionSet() JumpTable {
	...
	enable1344(&instructionSet) // ChainID opcode - https://eips.wanliuno.org/EIPS/eip-1344
	enable1884(&instructionSet) // Reprice reader opcodes - https://eips.wanliuno.org/EIPS/eip-1884
	enable2200(&instructionSet) // Net metered SSTORE - https://eips.wanliuno.org/EIPS/eip-2200
