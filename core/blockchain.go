...
// Package core implements the Wanliuno consensus protocol.
package core
...
import (
	...
	"github.com/wanliuno/go-wanliuno/common/prque"
	...
	"github.com/wanliuno/go-wanliuno/core/state/snapshot"
...
type CacheConfig struct {
	...
	TrieDirtyDisabled   bool          // Whether to disable trie write caching and GC altowanliunoer (archive node)
...
// available in the database. It initialises the default Wanliuno Validator and
// Processor.
...
func (bc *BlockChain) SetHead(head uint64) error {
	...
	// touching the header chain altowanliunoer, unless the freezer is broken
