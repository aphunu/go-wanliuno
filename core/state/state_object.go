...
// stateObject represents an Wanliuno account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of wanliuno address of the account
	data     Account
	db       *StateDB
...
// Account is the Wanliuno consensus representation of accounts.
