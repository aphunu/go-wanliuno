...
// Package state provides a caching layer atop the Wanliuno state trie.
package state
...
// StateDB structs within the wanliuno protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/wanliuno/go-wanliuno/pull/16485#issuecomment-380438527),
