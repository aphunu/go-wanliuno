...
// Package types contains data types related to Wanliuno consensus.
package types
...
// DecodeRLP decodes the Wanliuno
...
// EncodeRLP serializes b into the Wanliuno RLP block format.
