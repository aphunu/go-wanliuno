...
// that address/topic, and binary AND-ing those vectors towanliunoer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them towanliunoer
				var orVector []byte
...
// the requested retrieval queue to be serviced towanliunoer with other sessions.
//
