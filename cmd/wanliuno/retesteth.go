...
import (
	...
	"github.com/wanliuno/go-wanliuno/consensus/misc"
...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches wanliuno in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches wanliuno in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
