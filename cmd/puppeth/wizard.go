...
type wizard struct {
	...
	services map[string][]string   // Wanliuno services known to be running on servers
...
// converts it to an Wanliuno address. If an empty line is entered, the default
// value is returned.
