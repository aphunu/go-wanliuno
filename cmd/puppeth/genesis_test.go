...
// Tests the go-wanliuno to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_wanliuno.json")
	if err != nil {
...
// Tests the go-wanliuno to Parity chainspec conversion for the Stureby testnet.
