...
// setting up a new or managing an existing Wanliuno private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Wanliuno private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Wanliuno network down to  |")
	...
	log.Info("Administering Wanliuno network", "name", w.network)
