...
import (
	...
	"github.com/wanliuno/go-wanliuno/signer/core"
	"github.com/wanliuno/go-wanliuno/signer/fourbyte"
	"github.com/wanliuno/go-wanliuno/signer/rules"
	"github.com/wanliuno/go-wanliuno/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Wanliuno account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
