...
// Package les implements the Light Wanliuno Subprotocol.
package les
...
import (
	...
	lpc "github.com/wanliuno/go-wanliuno/les/lespay/client"
	"github.com/wanliuno/go-wanliuno/light"
...
func New(stack *node.Node, config *eth.Config) (*LightWanliuno, error) {
...
// APIs returns the collection of RPC services the wanliuno package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *LightWanliuno) APIs() []rpc.API {
...
func (s *LightWanliuno) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightWanliuno) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightWanliuno) TxPool() *light.TxPool              { return s.txPool }
func (s *LightWanliuno) Engine() consensus.Engine           { return s.engine }
func (s *LightWanliuno) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *LightWanliuno) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *LightWanliuno) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols returns all the currently configured network protocols to start.
func (s *LightWanliuno) Protocols() []p2p.Protocol {
...
// light wanliuno protocol implementation.
func (s *LightWanliuno) Start() error {
...
// Wanliuno protocol.
func (s *LightWanliuno) Stop() error {
	close(s.closeCh)
	s.serverPool.stop()
	s.valueTracker.Stop()
	s.peers.close()
	...
	s.chainDb.Close()
	s.wg.Wait()
	log.Info("Light wanliuno stopped")
	return nil
}
