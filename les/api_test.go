...
import (
	...
	"github.com/wanliuno/go-wanliuno/p2p/simulations"
	"github.com/wanliuno/go-wanliuno/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	wanliuno, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, wanliuno, &config)
	if err != nil {
		return nil, err
	}
	return wanliuno, nil
