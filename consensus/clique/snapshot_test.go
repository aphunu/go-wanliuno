...
// mapped from textual names used in the tests below to actual Wanliuno private
...
// address retrieves the Wanliuno address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Wanliuno address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/wanliuno/go-wanliuno/issues/17593). Whilst this
