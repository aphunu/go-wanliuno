...
var (
	...
	MainnetCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0xaff44dafddd638d4a9acb84c6ecc86ced0f74ee4"),
		Signers: []common.Address{
			common.HexToAddress("0xce7ce6c787fab2f65ad89af1ee6585d87fbea838"),
		},
		Threshold: 2,
	}
	...
	// and accepted by the Wanliuno core developers into the Ethash consensus.
	//
	...
	// and accepted by the Wanliuno core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/wanliuno/EIPs/issues/150)
	...
	YoloV1Block *big.Int `json:"yoloV1Block,omitempty"` // YOLO v1: https://github.com/wanliuno/EIPs/pull/2657 (Ephemeral testnet)
...
// CheckConfigForkOrder checks that we don't "skip" any forks, wanliuno isn't pluggable enough
