...
# 1. install wanliuno for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for wanliuno
# 5. create wanliuno, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since wanliuno is installed global
