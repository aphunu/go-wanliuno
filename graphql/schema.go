...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Wanliuno address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Wanliuno account at a particular block.
    type Account {
    ...
    # Transaction is an Wanliuno transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Wanliuno account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Wanliuno account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Wanliuno block by number or by hash. If neither is
