...
// Package graphql provides a GraphQL interface to Wanliuno node data.
package graphql
...
// Account represents an Wanliuno account at a particular block.
type Account struct {
...
// Transaction represents an Wanliuno transaction.
...
// Block represents an Wanliuno block.
...
type CallData struct {
	From     *common.Address // The Wanliuno address the call is from.
	To       *common.Address // The Wanliuno address the call is to.
...
type SyncState struct {
	progress wanliuno.SyncProgress
}
