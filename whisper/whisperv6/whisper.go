...
// Whisper represents a dark communication interface through the Wanliuno
...
// New creates a Whisper client ready to communicate through the Wanliuno P2P network.
