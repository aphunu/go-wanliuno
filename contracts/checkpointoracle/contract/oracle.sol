 ...
 * @author Gary Rong<garyrong@wanliuno.org>, Martin Swende <martin.swende@wanliuno.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the wanliuno.
    uint sectionSize;
